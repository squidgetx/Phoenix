...
ShiftTileMapLeft:
	...
	;ex de, hl
	;ld hl, gbuf
	ld b, 64	;number of rows to shift 	7
scrollRowLeft:	
	ex de, hl	;put sprite buffer to hl 	4
	rl (hl)		;shift first 4 bits			15
	dec hl		;							6
	...
	djnz scrollRowLeft	;repeat for all 64 rows		13 if skip, 7 otherwise
	;pop de
	ret

;cycle total within loop = 4+2(15+6)+4+12(15+6)+13 = 315
;cyle total outside loop = 7+7+10 = 24
;cycle total = 315*64+24 = 20184
